            ...
            <>
              {isEditing ? (
                <Textarea
                  ...
                  className="min-h-[140px] resize-none overflow-hidden rounded-[8px] border-[#D8D8DF] bg-[#FBFBFC] px-3 py-3 font-mono text-[13px] leading-6 text-[#191919] shadow-none focus-visible:border-[#4791CC] focus-visible:ring-2 focus-visible:ring-[#4791CC]/20"
                />
              ) : (
                <div
                  role="button"
                  ...
                  className="block min-h-[60px] w-full rounded-[8px] px-0 py-1 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4791CC]/25"
                >
                  {previewHtml ? (
                    <div
