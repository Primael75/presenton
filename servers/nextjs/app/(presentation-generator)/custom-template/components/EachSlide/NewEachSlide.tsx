      ...
      <div className="px-5 py-4 border-b border-[#F3F4F6] bg-gradient-to-r from-[#FAFAFA] to-white">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#E5F1FA] text-[#4791CC] font-semibold text-sm">
              {index + 1}
            </div>
            <div>
        ...
        {isSlideProcessing && (
          <div className="mt-4">
            <div className="flex items-center gap-2 mb-2">
              <Loader2 className="w-4 h-4 animate-spin text-[#4791CC]" />
              <span className="text-sm font-medium text-[#4791CC]">Generating slide layout...</span>
            </div>
            <Timer duration={120} />
          </div>
        )}
