...
const LayoutItem = memo(({ layout, onSelect }: LayoutItemProps) => {
  ...
  return (
    <div
      ...
      className="relative aspect-video cursor-pointer overflow-hidden rounded-md border border-[#E4E4EA] bg-white shadow-[0_1px_2px_rgba(16,24,40,0.04)] outline-none transition duration-200 hover:border-[#005B9A] hover:shadow-[0_0_0_2px_rgba(0,91,154,0.18)] focus-visible:ring-2 focus-visible:ring-[#005B9A]"
    >
  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-[64px] items-center justify-between border-b border-[#EDEEEF] px-5 py-4 md:px-6">
        ...
        {loading && (
          <Loader2 className="h-5 w-5 animate-spin text-[#005B9A]" />
        )}
      </div>
